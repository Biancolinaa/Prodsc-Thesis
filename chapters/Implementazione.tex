...
In questa pagina sono visibili tutte le informazioni relative alle conferenze.

È possibile consultare l'elenco delle conferenze con il rispettivo acronimo e rating, come visibile in Figura~\ref{fig:list-conferences}. Nel Listing~\ref{lst:django-template} è mostrato il codice per la visualizzazione della tabella delle conferenze.

Per ogni conferenza vi è poi un collegamento alla pagina dedicata che contiene le informazioni della conferenza, come visibile in Figura~\ref{fig:info-conference}.

\todo{Descrivere un po' l'immagine (quando ci sarà)}

Infine sono presenti le immagini ricavate dalle analisi fatte sui dati, con la spiegazione delle singole metriche.
...
\begin{figure}
  \centering
  \includegraphics[width=0.8\linewidth]{conference_info.png}
  \caption{Pagina per la visualizzazione delle informazioni di una singola conferenza}
  \label{fig:info-conference}
\end{figure}
...
Come fatto per le conferenze, anche per gli autori è disponibile una lista che mostra l'id dell'autore e il nome, come visibile in Figura~\ref{lista-autori}.
...
\begin{figure}
  ...
  \caption{Pagina per la visualizzazione della lista di autori}
